...
export const upgoer5: TranslationKeys = {
  ...
  scheduledTasks: "Stuff That Runs Later",
  viewScheduledTasks: "See and stop the stuff that runs later",
  noScheduledTasks: "No stuff to run later.",
  removeScheduledTask: "Stop this from running later",
  schedule: "When it runs",
  nextFire: "Next time",
  lastFire: "Last time",
  command: "What it does",
  persistent: "remembers",
