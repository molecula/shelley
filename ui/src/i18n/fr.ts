...
export const fr: TranslationKeys = {
  ...
  changeWorkingDirectory: "Changer le répertoire de travail",
  ...
  viewScheduledTasks: "Afficher et gérer les tâches planifiées",
  noScheduledTasks: "Aucune tâche planifiée.",
  removeScheduledTask: "Supprimer la tâche planifiée",
  ...
  gitRepo: "Dépôt Git",
  other: "Autre",
  sortConversations: "Trier les conversations",
  sortByActivity: "Activité récente",
  ...
  welcomeSubtitle: "",
  welcomeMessage:
    "Shelley est un agent qui s'exécute sur {hostname}. Vous pouvez demander à Shelley de faire des choses.",
