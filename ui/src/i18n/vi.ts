...
export const vi: TranslationKeys = {
  ...
  gitRepo: "Git Repo",
  other: "Khác",
  sortConversations: "Sắp xếp cuộc trò chuyện",
  sortByActivity: "Hoạt động gần đây",
  ...
  welcomeSubtitle: "",
  welcomeMessage:
    "Shelley là một agent lập trình chạy trên {hostname}. Bạn có thể yêu cầu Shelley xây dựng dự án.",
