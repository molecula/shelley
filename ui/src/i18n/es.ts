...
export const es: TranslationKeys = {
  ...
  changeWorkingDirectory: "Cambiar directorio de trabajo",
  ...
  viewScheduledTasks: "Ver y administrar tareas programadas",
  noScheduledTasks: "Sin tareas programadas.",
  removeScheduledTask: "Eliminar tarea programada",
  ...
  sortByActivity: "Actividad reciente",
