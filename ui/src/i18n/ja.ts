...
export const ja: TranslationKeys = {
  ...
  viewScheduledTasks: "スケジュールされたタスクを表示・管理",
  noScheduledTasks: "スケジュールされたタスクはありません。",
  removeScheduledTask: "スケジュールされたタスクを削除",
  schedule: "スケジュール",
  nextFire: "次回",
  lastFire: "前回",
  command: "コマンド",
  ...
  gitRepo: "Gitリポジトリ",
  other: "その他",
  sortConversations: "会話を並べ替え",
  sortByActivity: "最近のアクティビティ",
  sortByCreated: "作成日",
  sortByName: "名前",
