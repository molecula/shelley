...
import { api, UserSkillSummary } from "../services/api";
  ...
  if (skills.length === 0) {
    return (
      <div className="drawer-empty-state text-secondary">
        <p>No user-defined skills found.</p>
        <p className="skills-list-hint">
          Drop a <code>SKILL.md</code> into <code>~/.config/shelley/&lt;name&gt;/</code> or <code>.claude/skills/&lt;name&gt;/</code>.
        </p>
      </div>
    );
  }
